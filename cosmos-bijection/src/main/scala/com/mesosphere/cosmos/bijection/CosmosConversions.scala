...
object CosmosConversions {
  ...
  implicit val v2PackageToLabelV1PackageMetadata: Conversion[
    V2Package,
    PackageMetadata
  ...
  implicit val v3PackageToLabelV1PackageMetadata: Conversion[
    V3Package,
    PackageMetadata
  ...
  implicit val packageDefinitionToLabelV1PackageMetadata: Conversion[
    PackageDefinition,
    PackageMetadata
