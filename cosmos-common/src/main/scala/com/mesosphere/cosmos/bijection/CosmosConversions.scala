...
object CosmosConversions {
  ...
  implicit val v5PackageToLabelV1PackageMetadata
  : Conversion[universe.v5.model.V5Package, label.v1.model.PackageMetadata] = {
  ...
  : Conversion[universe.v4.model.PackageDefinition, label.v1.model.PackageMetadata] = {
    Conversion.fromFunction {
      ...
      case pkg: universe.v5.model.V5Package => v5PackageToLabelV1PackageMetadata(pkg)
    }
  }
