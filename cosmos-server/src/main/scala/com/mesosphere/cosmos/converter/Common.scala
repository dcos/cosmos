...
object Common {
  ...
  implicit val V2BundleToV2Package:
    Bijection[(model.V2Bundle, universe.v3.model.PackageDefinition.ReleaseVersion),
  ...
  implicit val V3BundleToV3Package:
    Bijection[(model.V3Bundle, universe.v3.model.PackageDefinition.ReleaseVersion),
  ...
  implicit val BundleToPackage:
    Bijection[(model.BundleDefinition, universe.v3.model.PackageDefinition.ReleaseVersion),
